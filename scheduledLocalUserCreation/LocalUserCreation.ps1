$users_csv="C:\Users\Administrator\powershell_scripts\scheduledLocalUserCreation\users.csv"
$date=Get-Date -Format dd-MM-yyyy
$log_file="C:\Users\Administrator\powershell_scripts\scheduledLocalUserCreation\LocalUsersLog$date.log"
